...
Gem::Specification.new do |s|
  ...
  s.rubyforge_project = "will_paginate-bootstrap4".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<will_paginate>.freeze, [">= 3.0.0", "~> 3.0"])
    else
      s.add_dependency(%q<will_paginate>.freeze, [">= 3.0.0", "~> 3.0"])
    end
  else
    s.add_dependency(%q<will_paginate>.freeze, [">= 3.0.0", "~> 3.0"])
  end
